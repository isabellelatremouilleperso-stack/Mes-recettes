...
<style>
    ...
    .recipe-img { widthimport streamlit as st
import requests
import pandas as pd
from datetime import datetime
import time
...
.stSidebar button { background-color: #e67e22; color: #0e1117 !important; font-weight:bold; margin-bottom:5px; }

/* --- LISTE D'ÉPICERIE --- */
.stCheckbox label p { color: white !important; font-size: 1.1rem !important; font-weight: 500 !important; }

/* --- INPUTS ET RECHERCHES --- */
input, select, textarea, div[data-baseweb="select"] { 
...
.logo-rond-centre {
    ...
    object-fit: cover; border: 4px solid #e67e22; margin-bottom: 15px;
}

/* --- HELP BOX --- */
.help-box { background-color:#1e2130; padding:20px; border-radius:15px; border-left:5px solid #e67e22; margin-bottom:20px;}
.help-box h3 { color:#e67e22; margin-top:0; }
</style>
""", unsafe_allow_html=True)

# ======================================================
# 2. URLS ET CATEGORIES
# ======================================================
URL_CSV = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRaY9boJAnQ5mh6WZFzhlGfmYO-pa9k_WuDIU9Gj5AusWeiHWIUPiSBmcuw7cSVX9VsGxxwB_GeE7u_/pub?gid=0&single=true&output=csv"
URL_CSV_SHOP = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRaY9boJAnQ5mh6WZFzhlGfmYO-pa9k_WuDIU9Gj5AusWeiHWIUPiSBmcuw7cSVX9VsGxxwB_GeE7u_/pub?gid=1037930000&single=true&output=csv"
URL_SCRIPT = "https://script.google.com/macros/s/AKfycbzE-RJTsmY5q9kKfS6TRAshgCbCGrk9H1e7YOmwfCsnBlR2lzrl35oEbHc0zITw--_z/exec"

CATEGORIES = ["Poulet","Bœuf","Porc","Agneau","Poisson","Fruits de mer","Pâtes","Riz","Légumes","Soupe","Salade",
              "Entrée","Plat Principal","Dessert","Petit-déjeuner","Goûter","Apéro","Sauce","Boisson","Autre"]

# ======================================================
# 3. FONCTIONS UTILITAIRES
# ======================================================
def send_action(payload):
    """Envoi des modifications à Google Script"""
...
def scrape_url(url):
    """Extraction titre et contenu depuis une URL"""
    try:
...
if st.session_state.page=="home":
    ...
    else: st.warning("Aucune recette trouvée.")
...
# --- PAGE DETAILS ---
    ...
    if c_nav2.button("✏️ Éditer"): st.session_state.page="edit"; st.rerun()
    if c_nav3.button("🗑️"): st.session_state.confirm_delete=True
    if st.session_state.get('confirm_delete',False):
        ...
        if c2.button("❌ NON"): st.session_state.confirm_delete=False; st.rerun()
    st.divider()
    ...
    with col_g:
        ...
        if st.button("💾 Enregistrer ma note et mon avis", use_container_width=True):
            succes = send_action({"action":"edit","titre":r['Titre'],"Note":nouvelle_note,"Commentaires":nouveau_comm})
            if succes:
...
# --- PAGE AJOUTER ---
    ...
    tab1,tab2,tab3=st.tabs(["🌐 Site Web","🎬 Vidéo","📝 Vrac"])
    with tab1:
        ...
        if google_query:
            ...
            st.markdown(f"[🌍 Rechercher sur Google]({google_url})")
        ...
        if st.button("🔍 Analyser le site"):
            if url_input:
                ...
                if t:
                    ...
                    st.session_state.temp_contenu=c
                else: st.error("Aucun contenu trouvé.")
            else: st.warning("Collez un lien d'abord.")
        if "temp_titre" in st.session_state:
            ...
            if col_save1.button("💾 Enregistrer"):
            ...
            if col_save2.button("❌ Annuler"): del st.session_state.temp_titre; st.rerun()
    with tab2:
        ...
        if st.button("🚀 Sauvegarder Vidéo"):
            ...
            else: st.warning("Remplissez le titre et le lien.")
    with tab3:
        ...
        with st.form("form_vrac"):
            ...
            v_txt=st.text_area("Texte ou ingrédients",height=300)
            if st.form_submit_button("💾 Enregistrer la recette"):
                if v_t:
                    ...
                    st.session_state.page="home"; st.rerun()
                else: st.error("Le titre est obligatoire.")
    ...
    try:
        ...
        if not df_s.empty:
            ...
            if c1.button("🗑 Retirer"): 
                for it in to_del: send_action({"action":"remove_shop","article":it}); st.rerun()
...
# --- PAGE PLAY STORE WOW ---
    ...
    <div class="playstore-container">
        ...
        <p style="font-size:1.: 100%; height: 130px; object-fit: cover; border-radius: 8px; }
    .recipe-title {
        color: white; margin-top: 8px; font-size: 0.95rem; font-weight: bold;
        text-align: center; display: flex; align-items: center; justify-content: center;
        height: 2.5em; line-height: 1.2;
...
# --- PAGE AIDE ---
    ...
    # Exemple de boîte d'aide avec style
    ca, cb = st.columns(2)
    with ca:
        st.markdown("""
        <div class="help-box">
            <h3>📝 Ajouter une Recette</h3>
            <p>Utilisez l'onglet <b>🌐 Site Web</b> pour importer depuis un site, 
            le <b>🎬 Vidéo</b> pour Instagram/TikTok/FB, 
            ou <b>📝 Vrac</b> pour saisie libre.</p>
        </div>
        """, unsafe_allow_html=True)
        ...
        <div class="help-box">
            <h3>🔍 Rechercher</h3>
            <p>Dans la bibliothèque, utilisez la recherche par titre ou filtre par catégorie. 
            La recherche fonctionne également sur les ingrédients.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with cb:
        ...
        <div class="help-box">
            ...
            <p>Cochez les ingrédients dans une recette puis cliquez sur "Ajouter au Panier". 
            Vous pouvez retirer ou vider la liste à tout moment.</p>
        </div>
        """, unsafe_allow_html=True)
        ...
        <div class="help-box">
            <h3>📅 Planning</h3>
            <p>Planifiez vos repas en remplissant la date prévue pour chaque recette. 
            Vous pouvez visualiser chaque fiche directement depuis le planning.</p>
        </div>
        """, unsafe_allow_html=True)
